...
int isEqualStudent(struct studentInfo a, struct studentInfo b){
    if(!strcmp(a.univ,b.univ) &&!strcmp(a.major, b.major) &&!strcmp(a.name, b.name) && a.sNo==b.sNo) return 1;
    else return 0;
}
...
int main(void){
    ...
    else printf("student 0 and student 3 are not same.");
